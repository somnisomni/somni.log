...
lastmod: 2026-02-21T08:41:12.877Z
cover:
  image: header.png
  relative: true
draft: false
...
<p align="center"><span style="color: red;"><strong>Test aborted for RPi 3B</strong></span> due to severe system freezing</p>
...
<p align="center"><strong><span style="color: green">+272.4%</span></strong> on ODROID-N2+</p>
...
<p align="center"><strong><span style="color: green">+375.7%</span></strong> on ODROID-N2+</p>
...
<p align="center"><strong><span style="color: green">+317.9%</span></strong> on ODROID-N2+</p>

#### Decompression Performance
{{< figure src="pts-7zip-decompression.png" >}}
<p align="center"><strong><span style="color: green">+157.1%</span></strong> on ODROID-N2+</p>
...
<p align="center"><strong><span style="color: green; font-size: 1.2em">+1141.9%</span></strong> on ODROID-N2+</p>
...
<p align="center"><strong><span style="color: green">+190.9%</span></strong> on ODROID-N2+</p>

#### Decompression Time
{{< figure src="pts-gzip-decompression.png" >}}
<p align="center"><strong><span style="color: green">+143.7%</span></strong> on ODROID-N2+</p>
...
<p align="center"><strong><span style="color: green">+198%</span></strong> on ODROID-N2+</p>
...
<p align="center"><strong><span style="color: green">+191.6%</span></strong> on ODROID-N2+</p>
...
<p align="center"><strong><span style="color: green; font-size: 1.5em">+2289.9%</span></strong> on ODROID-N2+</p>

#### RSA-4096 Signing
{{< figure src="pts-openssl-rsa4096-sign.png" >}}
<p align="center"><strong><span style="color: green">+200.3%</span></strong> on ODROID-N2+</p>

#### RSA-4096 Verification
{{< figure src="pts-openssl-rsa4096-verify.png" >}}
<p align="center"><strong><span style="color: green">+200.6%</span></strong> on ODROID-N2+</p>
...
<p align="center"><strong><span style="color: green; font-size: 1.25em">+1582.2%</span></strong> on ODROID-N2+</p>

#### 100 Connections
{{< figure src="pts-nginx-conn-100.png" >}}
<p align="center"><strong><span style="color: green; font-size: 1.25em">+1636.5%</span></strong> on ODROID-N2+</p>

#### 1,000 Connections
{{< figure src="pts-nginx-conn-1000.png" >}}
<p align="center"><strong><span style="color: green; font-size: 1.25em">+2310.4%</span></strong> on ODROID-N2+</p>

#### 4,000 Connections
{{< figure src="pts-nginx-conn-4000.png" >}}
<p align="center"><strong><span style="color: green; font-size: 1.25em">+2143.2%</span></strong> on ODROID-N2+</p>
